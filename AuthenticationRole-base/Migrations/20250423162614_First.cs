        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Writer = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<double>(type: "float(16)", precision: 16, scale: 2, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    Proberties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Form = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    binfet = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "a2f88c3b-1c9d-4a97-a85f-61c8d74f24d8", null, "admin", "ADMIN" },
                    { "b1d5a50e-2e62-45c6-917a-9e64a582f50h", null, "user", "USER" },
                    { "c3f6f974-3b3b-4dd8-b345-e2e6a4d8c0b9", null, "seller", "SELLER" }
                });
