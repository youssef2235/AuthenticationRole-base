...
CREATE TABLE [Products] (
    ...
    [Proberties] nvarchar(max) NULL,
    [Form] nvarchar(max) NULL,
    [binfet] nvarchar(max) NULL,
...
VALUES (N'a2f88c3b-1c9d-4a97-a85f-61c8d74f24d8', NULL, N'admin', N'ADMIN'),
(N'b1d5a50e-2e62-45c6-917a-9e64a582f50h', NULL, N'user', N'USER'),
(N'c3f6f974-3b3b-4dd8-b345-e2e6a4d8c0b9', NULL, N'seller', N'SELLER');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'ConcurrencyStamp', N'Name', N'NormalizedName') AND [object_id] = OBJECT_ID(N'[AspNetRoles]'))
...
VALUES (N'20250422003705_ahh', N'9.0.2');
